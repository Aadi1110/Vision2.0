...
5. Then, <b>BFS</b> (<i>Breadth First Search</i>) is used to determine all possible paths from the current position to the next destination. Among the paths secured, one with **minimum lenght** is considered
