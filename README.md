...
5. Then, <b>BFS</b> (<i>Breadth First Search</i>) is used to determine all possible paths from the current position to the next destination. <br> Among the paths secured, one with **minimum lenght** is considered
